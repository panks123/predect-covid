...
def download_file():
    # for downloading the database data in csv format
    patients=Patient.query.all()
    li=[]
    li.extend([['id','name','city','cough','fever','bpain','age','rNose','diffBreath','travelled','infectionProb']])
    for patient in patients:
        temp_li=[]
        temp_li.append(patient.id)
        temp_li.append(patient.name)
        temp_li.append(patient.city)
        temp_li.append(patient.cough)
        temp_li.append(patient.fever)
        temp_li.append(patient.bpain)
        temp_li.append(patient.age)
        temp_li.append(patient.rNose)
        temp_li.append(patient.diffBreath)
        temp_li.append(patient.travelled)
        temp_li.append(patient.infectionProb)
